...
from App.NEL_project.nel_app.evaluation.dataset_loader import DatasetLoader
from App.NEL_project.nel_app.evaluation.evaluation_handler import EvaluationHandler
from App.NEL_project.nel_app.evaluation.evaluation_ned import EvaluationNED
from App.NEL_project.nel_app.evaluation.evaluation_ner import EvaluationNER
...
if __name__ == "__main__":
    ...
    dataset_path = "evaluation_datasets/ace2004_short.json"
    ner_models = [
